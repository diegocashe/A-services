...
#Region "Abrir y cerrar PanelLateral"
    Private Async Sub TimerAbrirPanelLateral_Tick(sender As Object, e As EventArgs) Handles TimerAbrirPanelLateral.Tick
        ...
        If PanelLateral.Width = 130 Then
            ...
            ButtonMenu1.Text = "Solicitudes"
            ButtonMenu2.Text = "Usuario"

            ButtonMenu4.Text = "Rendimiento"
            ButtonMenu5.Text = "Configuration"
        End If
...
#Region "menu Y SubMenu"
    ...
    End Sub
    Private Sub ButtonMenu1_Click(sender As Object, e As EventArgs) Handles ButtonMenu1.Click
        Me.CargarFormularioHijos(Of FormSolicitudes)()
    End Sub
    Private Sub ButtonLogOut_Click(sender As Object, e As EventArgs) Handles ButtonLogOut.Click
        Application.Exit()

    End Sub
    Private Sub ButtonMenu2_Click(sender As Object, e As EventArgs) Handles ButtonMenu2.Click
        CargarFormularioHijos(Of FormUsuarios)()

    End Sub
    Private Sub ButtonMenu3_Click(sender As Object, e As EventArgs) 

    End Sub
    Private Async Sub ButtonMenu4_Click(sender As Object, e As EventArgs) Handles ButtonMenu4.Click
        Dim resp As Task = Task.Factory.StartNew(Sub()
                                                     ButtonMenu4.Invoke(New MethodInvoker(Sub()
                                                                                              If PanelSubMenu1.Visible = True Then

                                                                                                  ButtonMenu4.IconChar = FontAwesome.Sharp.IconChar.ChevronDown
                                                                                              Else
                                                                                                  ButtonMenu4.IconChar = FontAwesome.Sharp.IconChar.Cloudscale
                                                                                              End If
                                                                                          End Sub))
                                                     If PanelSubMenu1.Visible = True Then
        ...
        Await resp
    End Sub
    Private Async Sub ButtonMenu5_Click(sender As Object, e As EventArgs) Handles ButtonMenu5.Click

        Dim resp As Task = Task.Factory.StartNew(Sub()
                                                     ButtonMenu5.Invoke(New MethodInvoker(Sub()
                                                                                              If PanelSubMenu2.Visible = True Then

                                                                                                  ButtonMenu5.IconChar = FontAwesome.Sharp.IconChar.ChevronDown
                                                                                              Else
                                                                                                  ButtonMenu5.IconChar = FontAwesome.Sharp.IconChar.Cogs
                                                                                              End If
                                                                                          End Sub))
                                                     If PanelSubMenu2.Visible = True Then
...
#Region "Eventos mouseDown y mouseUp"
    ...
    Private Async Sub ButtonInicio_MouseUp(sender As Object, e As MouseEventArgs) Handles ButtonInicio.MouseUp
        ...
        Await resp
    End Sub
    Private Sub ButtonMenu1_MouseDown(sender As Object, e As MouseEventArgs) Handles ButtonMenu1.MouseDown
        Me.ButtonMenu1.Font = New System.Drawing.Font("Century Gothic", 9.0!, FontStyle.Regular, GraphicsUnit.Point, CType(0, Byte))
        Me.ButtonMenu1.IconSize = 20
    End Sub
    Private Sub ButtonMenu1_MouseUp(sender As Object, e As MouseEventArgs) Handles ButtonMenu1.MouseUp
        Me.ButtonMenu1.Font = New System.Drawing.Font("Century Gothic", 12.0!, FontStyle.Regular, GraphicsUnit.Point, CType(0, Byte))
        Me.ButtonMenu1.IconSize = 26
    End Sub
    Private Sub ButtonMenu2_MouseDown(sender As Object, e As MouseEventArgs) Handles ButtonMenu2.MouseDown
        Me.ButtonMenu2.Font = New System.Drawing.Font("Century Gothic", 9.0!, FontStyle.Regular, GraphicsUnit.Point, CType(0, Byte))
        Me.ButtonMenu2.IconSize = 20
    End Sub
    Private Sub ButtonMenu2_MouseUp(sender As Object, e As MouseEventArgs) Handles ButtonMenu2.MouseUp
        Me.ButtonMenu2.Font = New System.Drawing.Font("Century Gothic", 12.0!, FontStyle.Regular, GraphicsUnit.Point, CType(0, Byte))
        Me.ButtonMenu2.IconSize = 26
    End Sub

    Private Sub ButtonMenu4_MouseDown(sender As Object, e As MouseEventArgs) Handles ButtonMenu4.MouseDown
        Me.ButtonMenu4.Font = New System.Drawing.Font("Century Gothic", 9.0!, FontStyle.Regular, GraphicsUnit.Point, CType(0, Byte))
        Me.ButtonMenu4.IconSize = 20
    End Sub
    Private Sub ButtonMenu4_MouseUp(sender As Object, e As MouseEventArgs) Handles ButtonMenu4.MouseUp
        Me.ButtonMenu4.Font = New System.Drawing.Font("Century Gothic", 12.0!, FontStyle.Regular, GraphicsUnit.Point, CType(0, Byte))
        Me.ButtonMenu4.IconSize = 26
    End Sub
    Private Sub ButtonLogOut_MouseDown(sender As Object, e As MouseEventArgs) Handles ButtonLogOut.MouseDown
        Me.ButtonLogOut.Font = New System.Drawing.Font("Century Gothic", 9.0!, FontStyle.Regular, GraphicsUnit.Point, CType(0, Byte))
        Me.ButtonLogOut.IconSize = 20
    End Sub

    Private Sub ButtonLogOut_MouseUp(sender As Object, e As MouseEventArgs) Handles ButtonLogOut.MouseUp
        Me.ButtonLogOut.Font = New System.Drawing.Font("Century Gothic", 12.0!, FontStyle.Regular, GraphicsUnit.Point, CType(0, Byte))
...
#Region "Asignacion de Variables de tema"
    Private Sub CambioDeTema()
        ...
        PropiedadesIconButton(Me.ButtonMenu1)
        PropiedadesIconButton(Me.ButtonMenu2)

        PropiedadesIconButton(Me.ButtonMenu4)
        PropiedadesIconButton(Me.ButtonMenu4)
...
#Region "Panel Contenedor de Formularios"
    ...
    Private Sub IconButton1_Click_1(sender As Object, e As EventArgs)
        CargarFormularioHijos(Of FormAgregarComputadora)()
    End Sub

    Private Sub IconButton1_Click_2(sender As Object, e As EventArgs) 
        CargarFormularioHijos(Of FormAgregarComputadora)()
    End Sub
    ...
    Private Async Function AsignarToolTips() As Task
        Dim resp As Task = Task.Factory.StartNew(Sub()
                                                     ...
                                                     New MethodInvoker(Sub()
                                                                           ...
                                                                           ToolTipPrincipal.SetToolTip(Me.ButtonMenu1, ““)
                                                                           ToolTipPrincipal.SetToolTip(Me.ButtonMenu2, ““)

                                                                           ToolTipPrincipal.SetToolTip(Me.ButtonMenu4, ““)
                                                                           ToolTipPrincipal.SetToolTip(Me.ButtonMenu4, ““)
