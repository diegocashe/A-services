Imports Comun
Imports Dominio
Public Class FormAgregarNuevoTrabajador
    Dim DataTemp As New DataSet
    Dim BinPais, BinEstados, BinMunicipios, BinParroquias As New BindingSource
    Private Sub FormAgregarNuevoTrabajador_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        DatosDeDirecciones()
        LlenarBindings()
        Colores()
...
#End Region
    Private Sub BunifuFlatButton6_Click(sender As Object, e As EventArgs) Handles BunifuFlatButton6.Click
        Dim dom As New DatosTrabajadoresYTecnicos
        Dim idtemp, idtemp2 As Integer

        Try
            Dim pnombre, snombre, papellido, sapellido, Cedula, genero, correo, telefono, direccion, NivelEstudio, FechaNacimiento, FechaContrato, Especialidad As String
            ...
            Especialidad = DropdownEspecialidad.SelectedItem
            Dim a = MsgBox("Esta seguro de agragar al nuevo trabajador?", vbYesNo + vbQuestion, "Confirmacion")
            Select Case a
                Case vbYes
                    Try
                        ...
                        idtemp2 = dom.InsertarTrabajador(idtemp)
                        dom.InsertarTec(idtemp2, Especialidad)
                        dom.InCuentaUsuario(TBUsuario.Text, TBContra.Text, idtemp, "3")
