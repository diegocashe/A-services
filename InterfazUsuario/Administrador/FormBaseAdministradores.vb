...
Imports Comun
Public Class FormBaseAdministradores
...
#Region "Asignacion de Variables de tema"
    Private Sub CambioDeTema()
        ...
        PropiedadesIconButton(Me.IconButton4)
        PropiedadesIconButton(Me.IconButton5)
        PropiedadesIconButton(Me.IconButton5)
        ...
        Next
        Panel4.BackColor = TemaActual.Fondo
        Panel3.BackColor = TemaActual.Fondo
        Dim b = Panel4.Controls.OfType(Of FontAwesome.Sharp.IconButton)
        For Each btn2 In b
            PropiedadesIconButton(btn2)
        Next
        Dim c = Panel3.Controls.OfType(Of FontAwesome.Sharp.IconButton)
        For Each btn3 In c
...
#Region "Panel Contenedor de Formularios"
    ...
    Private Sub IconButton10_Click(sender As Object, e As EventArgs) Handles IconButton10.Click
        CargarFormularioHijos(Of FormActualizarDatosCliente)()

    End Sub

    Private Sub IconButton9_Click(sender As Object, e As EventArgs) Handles IconButton9.Click
        CargarFormularioHijos(Of FormActualizarEmpleadoCliente)()

    End Sub

    Private Sub IconButton5_Click(sender As Object, e As EventArgs) Handles IconButton5.Click
        CargarFormularioHijos(Of FormActualizarTrabajadores)()
    ...
    Private Async Sub ButtonMenu7_Click(sender As Object, e As EventArgs) Handles ButtonMenu3.Click
        Dim resp As Task = Task.Factory.StartNew(Sub()
                                                     ...
                                                     If Panel4.Visible = True Then
                                                         BTSubMenu.HideSync(Me.Panel4)
                                                     Else
                                                         BTSubMenu.ShowSync(Me.Panel4)
                                                     End If
                                                 End Sub)
        Await resp
    End Sub
    ...
    Private Async Sub ButtonMenu9_Click(sender As Object, e As EventArgs) Handles ButtonMenu4.Click
        Dim resp As Task = Task.Factory.StartNew(Sub()
                                                     ButtonMenu6.Invoke(New MethodInvoker(Sub()
                                                                                              If PanelSubMenu2.Visible = True Then
                                                     ...
                                                     If Panel3.Visible = True Then
                                                         BTSubMenu.HideSync(Me.Panel3)
                                                     Else
                                                         BTSubMenu.ShowSync(Me.Panel3)
                                                     End If
                                                 End Sub)
        Await resp
    End Sub
    ...
    Private Async Function AsignarToolTips() As Task
        Dim resp As Task = Task.Factory.StartNew(Sub()
                                                     ...
                                                     New MethodInvoker(Sub()
                                                                           ...
                                                                           ToolTipPrincipal.SetToolTip(Me.IconButton4, ““)
                                                                           ToolTipPrincipal.SetToolTip(Me.IconButton5, ““)
                                                                           ToolTipPrincipal.SetToolTip(Me.IconButton5, ““)
